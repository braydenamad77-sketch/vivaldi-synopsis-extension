...
function artworkFromShow(show: AnyRecord) {
...
function scoreTvmazeCandidate(entry: AnyRecord, expected: { title?: string; year?: number } = {}) {
...
export function pickBestTvmazeCandidate(results: AnyRecord[] | undefined, expected: { title?: string; year?: number } = {}) {
...
function pickBestTvmazeImage(images: AnyRecord[] | undefined) {
...
export async function fetchTvmazeArtwork(expected: { title?: string; year?: number } = {}) {
